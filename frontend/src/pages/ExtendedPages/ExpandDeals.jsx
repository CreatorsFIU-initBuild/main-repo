  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      >
        ...
        <div className="w-full h-135 flex justify-center items-end bg-[url('src/assets/expanded_products_banner.png')] bg-no-repeat bg-cover bg-center">
          <div className="flex flex-col gap-3 justify-center items-center bg-white opacity-90 h-fit rounded-2xl !-m-5 !py-10 !px-15">
            ...
            >
              One-Time-Only <span className="text-[orangered]">Deals!</span>
            </h1>
            <p className="font-bold !text-lg">
              Shop the latest deals from our creators.
            </p>
          </div>
        </div>
